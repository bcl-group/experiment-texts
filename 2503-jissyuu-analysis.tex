...
以下を読んで，筋電位(Electromyography)の性質を理解しておきましょう。

- 「筋電図の信号品質にかかわる要因とは？」: [https://delsys.com/japan/semg-technology](https://delsys.com/japan/semg-technology)
- 筋電位が大きいことが，ただちにその筋活動による関節モーメントが大きいことは意味しないことに注意
...
\subsection{データの前処理}
\begin{enumerate}
  \item 数値差分により速度や加速度を求める場合には，事前に低周波フィルタ(バターワースフィルタ)でノイズ処理を行う。
  \item 必要に応じて時間方向の正規化や加算平均を行う。
\end{enumerate}
